...
<img width="128" src="src/main/resources/assets/blockbot-discord/icon.png" >
...
Start the server tto create a config file. Complete the config file (can be found in `config/blockbot-discord.toml) with the following relevant data (Bot token, Guild ID, chat channel ID)
